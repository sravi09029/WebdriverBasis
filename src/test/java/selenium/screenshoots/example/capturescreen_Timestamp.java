...
public class capturescreen_Timestamp {
	...
	public static WebDriver driver;
	 ...
	 public static void capturescreenshooot() throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * File screenshoot = ((TakesScreenshot)
		 * driver).getScreenshotAs(OutputType.FILE); FileUtils.copyFile(screenshoot, new
		 * File(".//screenshoot//error.jpg"));
		 */
