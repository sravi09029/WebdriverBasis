...
public class groupsExamples {
	...
	@Test(priority = 3,dependsOnMethods = "first", alwaysRun = true, groups =  "Functional") //alwaysRun = true is a soft dependiences
	...
	@Test(priority = 4, dependsOnMethods = "second", groups = {"Functional", "smoke"}) //Multiple dependiences are addedd
	public void second() {
